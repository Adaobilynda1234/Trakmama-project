  ...
  return (
    <section className="bg-[#EDF8EC] mx-8 py-16">
      <div className="container mx-auto text-center">
        <button className="bg-deep-pink text-white px-8 py-2 rounded-sm mb-6">
          Get Access
        </button>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8">
          <div className="bg-white shadow-lg rounded-[64px] p-6 flex-1 max-w-sm mx-auto">
            ...
            <button
              className="bg-deep-pink text-white px-6 py-2 rounded-sm mb-8"
          ...
          <div className="bg-white shadow-lg rounded-[64px] p-6 flex-1 max-w-sm mx-auto">
            ...
            <p className="text-lg font-bold mb-4">$ 2</p>
            <button
              className="bg-deep-pink text-white px-6 py-2 rounded-sm mb-8"
          ...
          <div className="bg-white shadow-lg rounded-[64px] p-6 flex-1 max-w-sm mx-auto">
            ...
            <p className="text-lg font-bold mb-4">$ 1</p>
            <button
              className="bg-deep-pink text-white px-6 py-2 rounded-sm mb-8"
