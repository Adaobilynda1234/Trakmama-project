            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="lg:flex lg:justify-center">
                    ...
                    <div className="mt-8 lg:mt-0 lg:ml-8 lg:w-1/2">
                        ...
                        <p className="mt-4 text-xl text-black lg:text-justify font-light">Ensuring a confident and positive pregnancy experience, we are dedicated to providing expert-backed resources, support, and inspiration to guide you through your journey with services like:
                        </p>
                        <div className="flex flex-col items-center lg:flex-row lg:items-start mt-8 space-y-8 lg:space-y-0 lg:space-x-8">
                            <ul className="space-y-4 lg:text-left text-sm font-light text-black list-disc list-inside lg:list-outside lg:pl-8">
                                ...
                                <li>Our Community features give room to connect and network with other expectant mothers.</li>
                            </ul>
