...
const PaymentForm = () => {
  ...
  const onSuccess = async (reference) => {
    ...
    try {
      ...
      } = await axios.post("http://localhost:3001/create-customer", {
        email,
      });
      ...
      } = await axios.post("http://localhost:3001/create-subscription", {
    ...
    <section className="bg-tools-bg py-16">
      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-8">
        <div className="flex-1">
          <h2 className="text-3xl font-semibold mb-6 bg-white rounded-full py-8 text-center">
            Check Out
          </h2>
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="hidden  md:flex flex-col bg-white px-4 py-8 rounded-[64px] items-center">
              ...
              <button className="bg-deep-pink text-white px-6 py-2 rounded-md mb-4 block mx-auto">
                Get Started
              </button>
        ...
        <div className="bg-white shadow-lg rounded-[64px] p-8 flex-1">
          ...
          <PaystackButton
            className="paystack-button bg-button-green-light text-white py-2 px-4 rounded w-full"
            {...componentProps}
          />
        </div>
      </div>
